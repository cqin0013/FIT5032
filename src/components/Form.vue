            ...
            <div class="col-12 col-sm-10 col-md-8 col-lg-6 mx-auto">
                ...
                <form @submit.prevent="submitForm">
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" id="terms" v-model="formData.termsAgreed"
                            required />
                        <label class="form-check-label" for="terms">I agree to the Terms of Service</label>
                        <div v-if="errors.terms" class="text-danger mt-1">{{ errors.terms }}</div>
                    </div>
...
const formData = ref({
    ...
    reason: '',
    gender: '',
    termsAgreed: false // For Terms Agreement
})
...
const errors = ref({
    ...
    gender: null,
    reason: null,
    terms: null // Error for Terms Agreement
})
...
const validateTerms = (blur = false) => {
    let msg = null
    if (!formData.value.termsAgreed) msg = 'You must agree to the terms'
    if (blur || msg === null) errors.value.terms = msg
}
...
const clearForm = () => {
    Object.assign(formData.value, {
        ...
        reason: '',
        gender: '',
        termsAgreed: false // Reset terms agreement
    })
