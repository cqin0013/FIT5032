...
const routes = [
  ...
  { path: "/BooksTable", name: "BooksTable", component: BooksTableView },
  { path: "/AuthorsTable", name: "AuthorsTable", component: AuthorsTableView },
  { path: "/Geo", name: "Geo", component: GeoLocationView },
